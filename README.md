...
|--------|--------|-----------|
| Screen Capture | ❌ Not started | Integrate `scap` crate for DXGI |
...
- **Screen Capture:** [`scap`](https://github.com/nashaofu/scap) crate (handles DXGI, ScreenCaptureKit, PipeWire)
